...
$navItems = [
    ['href' => $basePath . '/dashboard',    'icon' => 'bi-speedometer2',    'label' => 'Dashboard'],
    ['href' => $basePath . '/contacts',     'icon' => 'bi-people',          'label' => 'Contacts'],
    ['href' => $basePath . '/lists',        'icon' => 'bi-list-ul',         'label' => 'Lists'],
    ['href' => $basePath . '/segments',     'icon' => 'bi-funnel',          'label' => 'Segments'],
    ['href' => $basePath . '/templates',    'icon' => 'bi-file-earmark-text','label' => 'Templates'],
    ['href' => $basePath . '/campaigns',    'icon' => 'bi-megaphone',       'label' => 'Campaigns'],
    ['href' => $basePath . '/automations',  'icon' => 'bi-diagram-3',       'label' => 'Automations'],
    ['href' => $basePath . '/reports',      'icon' => 'bi-bar-chart-line',  'label' => 'Reports'],
    ['href' => $basePath . '/smtp-servers', 'icon' => 'bi-server',         'label' => 'SMTP Servers'],
    ['href' => $basePath . '/settings',     'icon' => 'bi-gear',            'label' => 'Settings'],
];
?>
...
<nav id="sidebar">
    <div class="brand">
        <a href="<?= BASE_PATH ?>/dashboard"><i class="bi bi-envelope-paper-fill me-2"></i>Mail <span>Forge</span></a>
    </div>
...
<div id="main-content">
    <nav id="topbar" class="d-flex align-items-center justify-content-between">
        ...
        <div class="d-flex align-items-center gap-3">
            <a href="<?= BASE_PATH ?>/notifications" class="btn btn-sm btn-outline-secondary position-relative" title="Notifications">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li><a class="dropdown-item" href="<?= BASE_PATH ?>/profile"><i class="bi bi-person me-2"></i>Profile</a></li>
                    <li><a class="dropdown-item" href="<?= BASE_PATH ?>/settings"><i class="bi bi-gear me-2"></i>Settings</a></li>
                    <li><hr class="dropdown-divider"></li>
                    <li>
                        <form action="<?= BASE_PATH ?>/logout" method="POST" class="d-inline">
